...
const Banner = () => {
    return (
        <Box className="banner_section" sx={{ marginTop: '80px', backgroundImage: `url(${require('../../assets/images/background.png')})`, backgroundSize: 'cover', backgroundPosition: 'right', backgroundRepeat: 'no-repeat', height: 'calc(100vh - 80px)' }}>
